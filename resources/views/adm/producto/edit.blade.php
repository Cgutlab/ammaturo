        ...
        <form method="POST"  enctype="multipart/form-data" action="{{action('adm\ProductoController@update', $producto->id)}}" >
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nombre" name="nombre[{{$key}}]" placeholder="Ingrese el nombre" value="{{$producto->nombre[$key]}}">
                    </div>
                    <div class="form-group">
                        ...
                        <textarea class="form-control descripcion" id="descripcion" name="descripcion[{{$key}}]"  rows="3">
                            {!!$producto->descripcion[$key]!!}
                        </textarea>
                    </div>
                    <div class="form-group">
                        <label for="caracteristicas">Caracter&iacute;sticas ({{$lang['name']}})</label>
                        <textarea class="form-control descripcion" id="caracteristicas" name="caracteristicas[{{$key}}]"  rows="3">
                            {!!$producto->caracteristicas[$key]!!}
                        </textarea>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="video_{{$key}}" name="video[{{$key}}]"  aria-describedby="videoHelp" placeholder="Ingrese el codigo del video" value="{{$producto->video[$key]}}">
                    </div>
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <div>
                        <img class="img_slider" src="{{ asset($producto->plano) }}" alt="">
                    </div>
                </div>
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <select class="js-example-basic-multiple form-control" id="relacionados" name="relacionados[]" multiple="multiple" style="width:100%">
                            ...
                            @foreach($productos as $producto_op)
                                @if($producto->id != $producto_op->id)
                                    <option value="{{$producto_op->id}}">{!! $producto_op->nombreselect_format !!}</option>
                                @endif
                            @endforeach
                        </select>
                    </div>
