...
<div class="contenido">
    <div class="col-12">
        ...
        <form method="POST"  enctype="multipart/form-data" action="{{action('adm\IngenieriaController@store')}}">
            @csrf
            <div class="row">
                <div class="col-12">
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="titulo" name="titulo[{{$key}}]"  aria-describedby="ordenHelp" placeholder="Ingrese el título">
                    </div>
                    <div class="form-group">
                        <label for="subtitulo">Sub T&iacute;tulo({{$lang['name']}})</label>
                        <input type="text" class="form-control" id="subtitulo" name="subtitulo[{{$key}}]"  aria-describedby="ordenHelp" placeholder="Ingrese el subtítulo">
                    </div>
                    <div class="form-group">
