                ...
                <div class="col-12">
                    <div class="input-group mb-3">
                        <div class="custom-file">
                            ...
                            <label class="custom-file-label" id="img_label" for="imagen">Seleccione la imagen (Tamaño recomendado: 1400x620px)</label>
                        </div>
                    </div>
            ...
            <div class="row">           
                @foreach (LaravelLocalization::getSupportedLocales() as $key => $lang)
                    <div class="col-6">
                        ...
                        <textarea class="form-control contenido" id="contenido_{{$key}}" name="contenido[{{$key}}]"  rows="3">{{$slider->contenido[$key]}}</textarea>
                        </div>
                    </div>
                @endforeach  
            </div>
